...
Проекты: grafin, kronon, realtor, sp500-bounce-bot, скринер, транскрибатор.
...
"добавление в проект sp500-bounce-bot: описание..." → {"intent":"note","project":"sp500-bounce-bot","text":"описание..."}
